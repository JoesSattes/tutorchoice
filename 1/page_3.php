	    	...
	    	<ul class="nav navbar-nav navbar-right">
				<li>
					<a href="components-documentation.html" target="_blank">
						<i class="material-icons">dashboard</i> Sign In
					</a>
				</li>
				<li>
					<a href="http://demos.creative-tim.com/material-kit-pro/presentation.html?ref=utp-freebie" target="_blank">
						<i class="material-icons">unarchive</i> Log In
					</a>
				</li>
				<li>
...
<div class="row">
<div class="col-md-6">
    <img style="width: 100%;" class="img-rounded img-responsive img-raised" src="assets/img/examples/chris6.jpg">
</div>
<div class="col-md-6">
